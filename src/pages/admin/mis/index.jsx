...
const aiSummary = [
  "This report covers the period from 01 January 2026 to 06 July 2026 (6 months). During this period, the Bihar Sahyog Helpline Portal received a total of 48,732 complaints across 12 districts and 6 ULBs.",
  "",
  "Key Highlights:",
              ...
              <div className="flex gap-2 mt-4">
                <Button
                  ...
                  onClick={() => {
                    ...
                    doc.setFontSize(16);
                    doc.text(
                      "Bihar Sahyog Helpline Portal - MIS Cover Note",
                      14,
                      20,
                    );
                    doc.setFontSize(10);
