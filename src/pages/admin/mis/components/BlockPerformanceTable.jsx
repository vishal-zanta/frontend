...
import BlockPerformanceCards from "./BlockPerformanceCards";
import { useLanguage } from "@/context/LanguageContext";

export default function BlockPerformanceTable({ reportRows = [] }) {
  const { t } = useLanguage();
  const isMobile = useIsMobile();

  if (isMobile) {
    return <BlockPerformanceCards reportRows={reportRows} />;
  }

  const tableHeaders = [
    { id: "block", label: t("Block", "प्रखंड") },
