        ...
        {tab === "call-volume" && (
          <div className="space-y-6">
            ...
            <ChartCard
              ...
              subtitle={`Peak hour: ${pd.peakHour}`}
            >
              <LineChartCard
                data={pd.chartData}
                xKey={pd.chartXKey}
        ...
        {tab === "citizen-interaction" && (
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              >
                <RadarChartCard
                  data={CITIZEN_INTERACTION.channelSatisfaction.map((c) => ({
                    subject: c.channel,
                    A: c.satisfaction,
                    B: c.volume / 5000,
                  }))}
              ...
              >
                <BarChartCard
                  data={CITIZEN_INTERACTION.topIssues}
                  xKey="issue"
                  bars={[
                    {
                      key: "interactions",
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-xl border border-border overflow-hidden">
              <div className="px-5 py-3 border-b border-border flex items-center justify-between">
                <h3 className="font-bold text-foreground flex items-center gap-2">
                  <Activity className="w-5 h-5 text-blue-500" /> API Endpoint
                  Health
                </h3>
                <ExportButton
                  data={API_ENDPOINTS}
            ...
            <div className="bg-white rounded-xl border border-border overflow-hidden">
              <div className="px-5 py-3 border-b border-border">
                <h3 className="font-bold text-foreground flex items-center gap-2">
                  <AlertTriangle className="w-5 h-5 text-amber-500" /> Recent
