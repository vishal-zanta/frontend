              ...
              ? [
                  {
                    ...
                    csat: "-",
                    status: `${IVR_STATS.successRate}%`,
                  },
                  {
                    label: "Avg Talk Time",
                    calls: IVR_STATS.avgTalkTime,
                    answered: "-",
                    csat: "-",
                    status: "-",
                  },
                  {
                    label: "Active Agents",
                    calls: `${IVR_STATS.activeAgents}/${IVR_STATS.totalAgents}`,
                    answered: "-",
                    csat: "-",
                    status: "-",
                  },
          ...
          : selectedReport === "agent"
            ...
            : selectedReport === "ivr"
              ? [
                  ...
                  { key: "calls", label: "Value 1" },
                  { key: "answered", label: "Value 2" },
              ...
              <thead className="bg-muted/50">
                <tr className="text-left text-xs text-muted-foreground">
                  {selectedReport === "officer" ? (
                    ...
                    <>
                      <th className="px-3 py-2 font-medium">ULB</th>
                      <th className="px-3 py-2 font-medium text-right">
                        Complaints
                      </th>
                      <th className="px-3 py-2 font-medium text-right">
                    ...
                    <>
                      ...
                      <th className="px-3 py-2 font-medium">Avg Talk</th>
                ...
                {selectedReport === "officer" ? (
                  ...
                  AGENT_PERFORMANCE.map((a, i) => (
                    <tr key={i} className="hover:bg-muted/30">
                      ...
                      <td className="px-3 py-2 text-amber-600">★ {a.csat}/5</td>
                      <td className="px-3 py-2 text-right">
                        {a.slaCompliance}%
                      </td>
                      <td className="px-3 py-2 text-amber-600">★ {a.csat}/5</td>
                  ...
                  <>
                    <tr className="hover:bg-muted/30">
                      ...
                      <td className="px-3 py-2 text-right">
                        {IVR_STATS.totalCallsToday.toLocaleString("en-IN")}
                      </td>
                      <td className="px-3 py-2 text-right">
                        {IVR_STATS.callsAnswered.toLocaleString("en-IN")}
                      </td>
                      <td className="px-3 py-2">-</td>
                      <td className="px-3 py-2">{IVR_STATS.successRate}%</td>
                    </tr>
                    <tr className="hover:bg-muted/30">
                      <td className="px-3 py-2 font-medium">Avg Talk Time</td>
                      <td className="px-3 py-2 text-right">
                        {IVR_STATS.avgTalkTime}
                      </td>
                    ...
                    <tr className="hover:bg-muted/30">
                      <td className="px-3 py-2 font-medium">Active Agents</td>
                      <td className="px-3 py-2 text-right">
                        {IVR_STATS.activeAgents}/{IVR_STATS.totalAgents}
                      </td>
                      <td className="px-3 py-2 text-right">-</td>
                      <td className="px-3 py-2">-</td>
                      <td className="px-3 py-2">-</td>
