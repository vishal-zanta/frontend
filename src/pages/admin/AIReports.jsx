    ...
    try {
      ...
      for (let i = 0; i < children.length; i++) {
        ...
        if (currentY + childHeight > pageHeight + margin && !isFirstPage) {
          ...
          currentY + childHeight > pageHeight + margin &&
          isFirstPage
        ) {
          doc.addPage();
          currentY = margin;
      ...
      doc.save(
        `AI_Analytical_Report_${new Date().toISOString().slice(0, 10)}.pdf`,
      );
    } catch (error) {
  ...
  return (
    <PortalLayout role="superadmin">
      <div className="p-4 sm:p-6 space-y-4 sm:space-y-6">
        <div className="flex items-center justify-between">
          ...
          <div className="flex flex-col items-start sm:items-end w-full lg:items-start xl:items-end  gap-3">
            ...
            <Button
              ...
              disabled={exporting}
              size={"sm"}
              className="bg-gradient-to-r from-red-600 to-rose-600 hover:from-red-700 hover:to-rose-700 text-white font-medium  rounded-lg shadow-sm hover:shadow transition-all flex items-center justify-center gap-1.5 cursor-pointer border-0"
            >
              {exporting ? (
                <>
        ...
        <div className="space-y-4 sm:space-y-6 ai-report-pdf">
          {/* AI Insights - Generate button */}
          <div className="bg-gradient-to-r from-purple-600 to-indigo-600 rounded-xl xs:rounded-2xl p-3 xs:p-4 sm:p-5 md:p-6 text-white">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 xs:gap-4 sm:gap-6">
              <div className="flex items-start gap-2.5 xs:gap-3 sm:gap-4">
                <div className="w-9 h-9 xs:w-10 xs:h-10 sm:w-12 sm:h-12 rounded-lg xs:rounded-xl bg-white/20 flex items-center justify-center shrink-0">
                  <Brain className="w-5 h-5 xs:w-6 xs:h-6 sm:w-7 sm:h-7" />
                </div>
                <div className="flex-1 space-y-0.5 xs:space-y-1">
                  <h2 className="text-base xs:text-lg sm:text-xl md:text-2xl font-bold leading-tight">
                    {t(
                      "AI-Generated Insights",
                      "AI द्वारा जनरेट की गई अंतर्दृष्टि",
                    )}
                  </h2>
                  <p className="text-xs xs:text-sm md:text-base text-white/80">
                    {period === "weekly"
                      ? t("Next Week", "अगले सप्ताह")
                      : t("Next Month", "अगले महीने")}{" "}
                    {t(
                      "Volume Prediction & Key Recommendations",
                      "मात्रा पूर्वानुमान और मुख्य सिफारिशें",
                    )}
                  </p>
                </div>
              </div>
              <Button
                ...
                disabled={generating}
                className="w-full sm:w-auto bg-white/20 hover:bg-white/30 text-white text-xs xs:text-sm px-3 py-1.5 xs:px-4 xs:py-2 shrink-0"
              >
                {generating ? (
                  <>
                    <Loader2 className="w-3.5 h-3.5 xs:w-4 xs:h-4 mr-1 animate-spin" />{" "}
            ...
            {showInsights && !generating && (
              <div className="mt-3 xs:mt-4 space-y-2 pt-3 border-t border-white/10">
                {AI_PREDICTIONS.insights.map((insight, i) => (
                  <div key={i} className="flex items-start gap-2 text-xs xs:text-sm">
                    <Sparkles className="w-3.5 h-3.5 xs:w-4 xs:h-4 text-yellow-300 shrink-0 mt-0.5" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <ChartCard
              ...
              subtitle={t(
                "AI-predicted complaint volume by department",
                "विभाग द्वारा AI-पूर्वाअनुमानित शिकायत की मात्रा",
              )}
            >
              <BarChartCard
                data={
            ...
            <ChartCard
              ...
              subtitle={t(
                "Grievance distribution by service category",
                "सेवा श्रेणी द्वारा शिकायत विवरण",
              )}
            >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <ChartCard
              ...
              subtitle={t(
                "30-day time-series with trend line",
                "रुझान रेखा के साथ 30-दिवसीय समय-श्रृंखला",
              )}
            >
              <LineChartCard
                data={DAILY_VOLUME}
            ...
            <ChartCard
              ...
              subtitle={t(
                "6-month raised vs resolved",
                "6 महीने में दर्ज बनाम निराकृत",
              )}
            >
              <AreaChartCard
                data={MONTHLY_VOLUME}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <ChartCard
              title={t(
                "AI Hotspot & Cluster Map",
                "AI हॉटस्पॉट और क्लस्टर मानचित्र",
              )}
              subtitle={t(
                "Predicted complaint hotspots by ward",
                "वार्ड द्वारा पूर्वाअनुमानित शिकायत हॉटस्पॉट",
              )}
            >
              <ComplaintMap
                height={320}
            ...
            <ChartCard
              ...
              subtitle={t(
                "Top complaint density areas",
                "शीर्ष शिकायत घनत्व क्षेत्र",
              )}
            >
          ...
          <ChartCard
            ...
            subtitle={t(
              "AI scatter analysis - ULB population rank vs complaint volume",
              "AI प्रकीर्णन विश्लेषण - ULB जनसंख्या रैंक बनाम शिकायत मात्रा",
            )}
          >
            <ScatterChartCard
          ...
          <div className="bg-white dark:bg-card rounded-xl border border-border p-5">
            <h3 className="font-bold text-foreground mb-4 flex items-center gap-2">
              ...
              {t("AI Model Confidence", "AI मॉडल विश्वसनीयता")}
            </h3>
