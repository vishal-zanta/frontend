        ...
        <div className="p-6 space-y-6">
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              View your assigned shift schedule. Shift management is available
              to supervisors only.
            </p>
          </div>
          ...
          <div className="bg-white rounded-xl border border-border p-5 max-w-2xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
              ...
              <div className="bg-muted/50 rounded-lg p-3">
                ...
                <Badge
                  variant="outline"
                  className={`text-xs ${myAgent.status === "Available" ? "bg-emerald-50 text-emerald-700" : myAgent.status === "On Call" ? "bg-amber-50 text-amber-700" : "bg-slate-50 text-slate-500"}`}
                >
                  {myAgent.status}
                </Badge>
              </div>
    ...
    <PortalLayout role="crm">
      <div className="p-6 space-y-6">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Set agent shift timings, view live status, and manage call centre
            operations.
          </p>
        </div>
