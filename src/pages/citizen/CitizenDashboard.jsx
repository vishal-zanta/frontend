    ...
    <PortalLayout role="citizen">
      <div className="p-6 space-y-6">
        ...
        <div className="bg-gradient-to-r from-blue-900 to-blue-600 rounded-2xl p-6 text-white flex items-start justify-between">
          ...
          <button onClick={toggle} className="px-3 py-1.5 bg-white/20 hover:bg-white/30 rounded-lg text-sm text-white font-medium whitespace-nowrap">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <div className="group bg-white rounded-xl border-2 border-purple-100 hover:border-purple-400 p-6 transition-all hover:shadow-lg cursor-pointer" onClick={() => document.querySelector("[class*='fixed bottom-6 right-6']")?.click()}>
