...
export default function ChatPanel({ onClose, currentUserId }) {
  ...
  return (
    <div
      className="absolute bottom-2 -right-3 xs:right-0 w-[min(400px,95vw)] bg-white rounded-2xl shadow-2xl border border-slate-200/60 overflow-hidden flex flex-col"
