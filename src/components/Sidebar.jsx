...
const sidebarSections = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        path: "/officer",
        icon: LayoutDashboard,
        // permissions: ["ALL_GRIEVANCE", "UPDATE_GRIEVANCE"],
      },
      {
        label: "Dashboard",
        path: "/crm",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        path: "/crm/raise",
        icon: FileText,
        permissions: ["CREATE_GRIEVANCE","ALL_GRIEVANCE"],
      },
      {
